...
public class LearnHyperLink {
	...
	public void run() throws MalformedURLException {
		...
		System.out.println("Crio.do link is displayed: "+isdis);
		// TODO: Check if the link "Crio.Do" is enabled - call the method
		// checkElementIsEnabled()
		boolean isen = this.checkElementIsEnabled(linkCrioDo);
		System.out.println("Crio.do link is enabled: "+isen);
		...
		System.out.println("Total links present on the page : "+totallink);
		...
		System.out.println("Number of links visible: "+visible);
		System.out.println("Number of links not visible : "+notvisible);
